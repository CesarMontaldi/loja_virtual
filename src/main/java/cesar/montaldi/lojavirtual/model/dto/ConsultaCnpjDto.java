...
public class ConsultaCnpjDto implements Serializable{
	...
	private String sisutacao_especial;
	private String data_sisutacao_especial;
	...
	public String getSisutacao_especial() {
		return sisutacao_especial;
	}

	public void setSisutacao_especial(String sisutacao_especial) {
		this.sisutacao_especial = sisutacao_especial;
	}

	public String getData_sisutacao_especial() {
		return data_sisutacao_especial;
	}

	public void setData_sisutacao_especial(String data_sisutacao_especial) {
		this.data_sisutacao_especial = data_sisutacao_especial;
	}
